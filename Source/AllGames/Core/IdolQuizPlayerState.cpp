...
void AIdolQuizPlayerState::SetQuizPlayerName(const FString& InName){if(HasAuthority()){QuizPlayerName=InName.TrimStartAndEnd().Left(20);if(QuizPlayerName.IsEmpty())QuizPlayerName=TEXT("Player");SetPlayerName(QuizPlayerName);}}
