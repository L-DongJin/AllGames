...
private:
	...
	void AddChatMessage(const FString& Message); void RefreshChatText(); void RefreshPlayerSlots(int32 LocalCorrectCount); void OpenChatInput(); void CloseChatInput();
	...
	UPROPERTY(Transient)TObjectPtr<AIdolQuizGameModeBase>QuizGameMode; TArray<FVisibleChatMessage>ChatMessages; FString LocalPlayerName=TEXT("Player"); bool bChatInputOpen=false;
};
