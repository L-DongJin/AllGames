param(
    [string]$DatasetRoot = "SourceAssets/IdolQuiz/Naruto",
...
$sourcePage = "https://www.piku.co.kr/w/1n1mH1"
$rankingPage = "https://www.piku.co.kr/w/rank/1n1mH1"
$rankingEndpoint = "https://www.piku.co.kr/w/rank/x.php?u=1n1mH1"
...
if (Test-Path -LiteralPath $manifestPath) {
    ...
    for ($index = 0; $index -lt $rows.Count; $index++) {
        ...
        $records.Add([ordered]@{
            ...
            answer = $cleanName
            image_url = $imageUrl
            saved_filename = "NARUTO_$('{0:D3}' -f ($index + 1)).png"
            status = "pending"
            width = $null
            height = $null
            size_bytes = $null
