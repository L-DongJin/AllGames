...
SONGS = [
    {
        ...
        "asset_prefix": "Drama",
        "title": "Drama",
        "music": "/Game/Audio/Music/에스파-Drama",
        "recording_dir": "DramaAudioStemDifficulties",
        "preview_start": 53.0,
    },
    {
        "source_name": "Bansanka",
        "asset_prefix": "Bansanka",
        "title": "만찬가",
        "music": "/Game/Audio/Music/tuki-만찬가",
        "recording_dir": "BansankaDifficulties",
        "preview_start": 54.0,
    },
]
...
def main():
    ...
    unreal.log("DRAMA / BANSANKA CHARTS READY: {}".format(
